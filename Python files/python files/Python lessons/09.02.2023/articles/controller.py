    ...
    def check_user_answer(self, answer):
        if answer == '1':
            ...
            try:
                ...
                self.user_interface.show_incorrent_title_error(article_title)
            else:
            ...
            try:
                ...
                self.user_interface.removr_single_article(title)
        elif answer == 'q':
            self.article_model.save_data()
        else:
            self.user_interface.show_incorrect_asnwer_error(answer)
